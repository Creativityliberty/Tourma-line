...
export const internationalCities = [
  ...
  { slug: "liege", name: "Liège", region: "Wallonie", country: "Belgique", flag: "🇧🇪", type: "international" },
...
export const allCities = [...localCities, ...nationalCities, ...internationalCities];
