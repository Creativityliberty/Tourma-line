  ...
  return (
    <div className="bg-brand-lilas text-brand-dark font-sans">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        <h1 className="text-4xl font-display text-brand-dark mb-6">
          Mentions légales
        </h1>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 text-sm leading-relaxed">
            ...
            <strong>Tourma-Line - Line Simon</strong>
            <br />
            Tourmaline, 76540 Gerponville, France
            <br />
            SIRET : 931 165 336 00013
            <br />
            Téléphone :{" "}
            <a
              href="tel:0649653186"
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 text-sm leading-relaxed">
            ...
            graphismes, logo, mises en page, etc.) est, sauf mention contraire,
            la propriété exclusive de Tourma-Line. Toute reproduction,
            représentation, modification, diffusion ou exploitation, totale ou
            partielle, des contenus du site, par quelque procédé que ce soit,
            sans l'autorisation écrite préalable de Tourma-Line, est strictement
            interdite et est susceptible de constituer une contrefaçon au sens
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 text-sm leading-relaxed mb-3">
            Les informations collectées par le biais des formulaires de contact
            ou de prise de rendez-vous sont utilisées uniquement pour répondre
            aux demandes des utilisateurs et pour la gestion des rendez-vous.
          </p>
          <p className="text-gray-700 text-sm leading-relaxed">
            Conformément au Règlement Général sur la Protection des Données
            (RGPD) et à la loi "Informatique et Libertés", vous disposez d'un
            droit d'accès, de rectification, d'opposition et de suppression des
            données vous concernant. Pour exercer ces droits, vous pouvez
            contacter Tourma-Line à l'adresse email suivante :
            <a
              href="mailto:line.simon.ls@gmail.com"
              className="text-brand-purple hover:underline"
            >
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-3">5. Responsabilité</h2>
          <p className="text-gray-700 text-sm leading-relaxed">
            Les informations fournies sur ce site ont un caractère purement
            informatif et ne sauraient remplacer un avis médical, psychologique
            ou juridique. Tourma-Line ne pourra être tenue responsable des
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-3">6. Liens externes</h2>
          <p className="text-gray-700 text-sm leading-relaxed">
            Le site peut contenir des liens vers d'autres sites internet.
            Tourma-Line n'exerce aucun contrôle sur le contenu de ces sites
            tiers et ne saurait être tenue responsable de leur contenu ou de
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 text-sm leading-relaxed">
            ...
            pouvez contacter Tourma-Line à l'adresse suivante :
            <a
              href="mailto:line.simon.ls@gmail.com"
              className="text-brand-purple hover:underline"
            >
