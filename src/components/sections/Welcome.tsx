          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            <AnimateOnScroll animationClass="animate-fadeInRight" delay={400}>
              <div className="bg-brand-lilas p-8 rounded-2xl shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:glow">
                ...
                <p className="text-gray-700">
                  Un accueil simple, un temps d&apos;échange respectueux de votre rythme. Christine cherchait à se libérer de son angoisse : « m&apos;a soulagé de mon angoisse ». Moins de tension, un sommeil plus réparateur, un vrai relâchement — ce que beaucoup ressentent après le soin LAHOCHI.
                </p>
              </div>
            </AnimateOnScroll>
          </div>
