                    ...
                    <div className="flex flex-col gap-12 max-w-5xl mx-auto">
                        {formules.map((formule, index) => (
                            <AnimateOnScroll
                                ...
                                delay={index * 150}
                            >
                                <div className="bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row-reverse transition-all duration-300 hover:shadow-2xl border border-brand-lilas/50">
                                    {formule.imageUrl && (
