                ...
                <div className="container mx-auto px-6 max-w-4xl text-center">
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm">
                        ...
                        <p className="text-sm text-gray-500 leading-relaxed">
                            Réceptions en cabinet à Gerponville (76540), à domicile à Fécamp, Valmont, Cany-Barville, Ourville-en-Caux, et en consultation à distance (téléphone / visio) pour toute la France. SIRET : 93116533600013.
                        </p>
                    </div>
                </div>
            </AnimateOnScroll>
