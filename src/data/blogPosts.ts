...
export const blogPosts: BlogPost[] = [
  {
    ...
    featured:    content: `
      ...
      <ul>
          <li><strong>Étape 1 : Séparez</strong> tous les chiffres de votre date entière. <code>1 + 5 + 0 + 7 + 1 + 9 + 8 + 5</code></li>
          <li><strong>Étape 2 : Additionnez</strong> l'ensemble pour obtenir un total. <code>1+5+0+7+1+9+8+5 = 36</code></li>
          <li><strong>Étape 3 : Réduisez</strong> ce total pour atteindre un chiffre entre 1 et 9. <code>3 + 6 = 9</code></li>
      </ul>
      ...
      <h3>Chemin 2 : L'Artisan de la Paix</h3>
      ...
      <h3>Chemin 3 : L'Étincelle Communicative</h3>
      ...
      <h3>Chemin 4 : L'Architecte Structuré</h3>
      ...
      <h3>Chemin 5 : L'Explorateur Libre</h3>
      ...
      <h3>Chemin 6 : Le Gardien de l'Harmonie</h3>
      ...
      <h3>Chemin 7 : Le Chercheur de Vérité</h3>
      ...
      <h3>Chemin 8 : Le Maître des Énergies (Alchimiste)</h3>
      ...
      <h3>Chemin 9 : Le Philanthrope Universel</h3>
      ...
      <h3>Les Maîtres Nombres (11, 22, 33)</h3>
      <ul>
          <li><strong>11 : L'Idéaliste Inspiré</strong> – Intuition fulgurante, sensibilité extrême.</li>
          <li><strong>22 : Le Grand Constructeur</strong> – Capacité à matérialiser de très hautes visions à grande échelle.</li>
      ...
      <h3>Je n'arrive pas à me reconnaitre dans la description, pourquoi ?</h3>
